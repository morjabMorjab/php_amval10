...
# کدهای کامل و بدون خطای نهایی برای فایل assets.php
...
def apply_manual_entry_fix():
    ...
    if os.path.exists(assets_file):
        try:
            ...
            print("✅ خطای ثبت دستی اموال برطرف شد، اموجی‌های متادیتا حذف شدند و تاریخ شمسی در باج پوستی در کنار جمعدار قرار گرفت.")
